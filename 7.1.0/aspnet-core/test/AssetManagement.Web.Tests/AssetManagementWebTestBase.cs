...
using AssetManagement.Models.TokenAuth;
...
{
    public abstract class AssetManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AssetManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AssetManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AssetManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AssetManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AssetManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AssetManagementDbContext, Task<T>> func)
        {
            T result;
